				...
				<div class="tabs-wrap">
					...
					<div class="collection-wrap">
						<ul class="collection-gallery">
							<li>
								<div class="item" v-for="(artwork, idx) in this.$store.state.artworks" :key="idx">
									<figure>
											<!-- <a href="#"
												style="background-image: url(dist/images/collection-1.jpg);"></a> -->
									</figure>
									<h3><a href="#">{{ artwork.acf.artwork_artist_label }}</a></h3>
									<h4><a href="#">{{ artwork.title.rendered }}</a></h4>
									<span class="date">Date: {{ artwork.acf.artwork_year }}</span>
									<span class="category">{{ artwork['artwork-types'] }}</span>
								</div>
							</li>
						</ul>
					</div>
